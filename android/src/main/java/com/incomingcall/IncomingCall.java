...
public class IncomingCall {
  ...
  public PendingIntent getPendingBroadcastIntent(String type, IncomingCallNotification config){
    ...
    PendingIntent pendingIntent = PendingIntent.getBroadcast(context, config.integerId, intent, PendingIntent.FLAG_UPDATE_CURRENT);
  ...
  public PendingIntent getActivityPendingIntent(String type, IncomingCallNotification config){
    ...
    config.populateIntentExtras(intent, type);
    PendingIntent pendingIntent = PendingIntent.getActivity(context, config.integerId, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    return pendingIntent;
  }
